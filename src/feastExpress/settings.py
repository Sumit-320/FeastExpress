"""
Django settings for feastExpress project.
...
ALLOWED_HOSTS = ['45.79.123.200','127.0.0.1','feastexpress.online','www.feastexpress.online']
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware', # default storage backend relies on sessions
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'orders.request_object.RequestObjectMiddleware', # custome middleware for created to access requestobject in models.py
]

ROOT_URLCONF = 'feastExpress.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'register.context_processors.get_paypal_client_id',
...
WSGI_APPLICATION = 'feastExpress.wsgi.application'
